...
import { setQuestion, createAnswerObject, setAnswer, answerAltered } from '../../actions/answers';
...
class Qnine extends Component {
  ...
  static propTypes = {
    ...
    answerAltered: React.PropTypes.func,
  ...
  onButtonPress() {
    const { question, record, rating, answersArray, score } = this.props;
        ...
        <Content>
           ...
           <Card style={styles.radios}>
              <SegmentedControls
                  ...
                  onSelection={value => this.props.answerAltered(value)}
              />
           </Card>
...
function bindAction(dispatch) {
  return {
    ...
    answerAltered: rating => dispatch(answerAltered(rating)),
