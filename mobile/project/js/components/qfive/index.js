      ...
      <Container style={styles.container}>
        ...
        <Content>
          ...
          <Grid style={styles.buttons}>
            <Col>
              <Button light rounded onPress={() => Actions.qfour()} style={styles.center}>
                  <Text>Back</Text>
              </Button>
            </Col>
            <Col>
              <Button rounded onPress={() => Actions.qsix()} style={styles.center}>
                  <Text>Next</Text>
              </Button>
            </Col>
          </Grid>
...
export default connect(mapStateToProps, bindAction)(Qfive);
