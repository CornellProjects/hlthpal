      ...
      <Container style={styles.container}>
        ...
        <Content>
           <Text style={styles.text}>
            ...
            <Col>
              <Button light rounded onPress={() => Actions.otherSymptoms()} style={styles.center}>
                  <Text>Back</Text>
              </Button>
            </Col>
            <Col>
              <Button rounded onPress={() => Actions.qthree()} style={styles.center}>
                  <Text>Next</Text>
              </Button>
            </Col>
          </Grid>
...
export default connect(mapStateToProps, bindAction)(pastWeek);
