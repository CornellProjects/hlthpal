    ...
    return (
      <Container style={styles.container}>
        <Header style={{backgroundColor:'#F16C00'}}>
          ...
          <Body>
            <Title>{(this.props.name) ? this.props.name : 'Question 2 - 3'}</Title>
          </Body>
          <Right>
        ...
        <Content>
          ...
          <Grid style={styles.buttons}>
            <Col>
              <Button light rounded onPress={() => Actions.qtwoTwo()} style={styles.center}>
                  <Text>Back</Text>
              </Button>
            </Col>
            <Col>
              <Button rounded onPress={() => Actions.qtwoFour()} style={styles.center}>
                  <Text>Next</Text>
              </Button>
            </Col>
          </Grid>
