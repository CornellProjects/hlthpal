...
class QtwoSeven extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header style={{backgroundColor:'#F16C00'}}>
          ...
          <Body>
            <Title>{(this.props.name) ? this.props.name : 'Question 2 - 7'}</Title>
          </Body>
          <Right>
        ...
        <Content>
          ...
          <Grid style={styles.buttons}>
            <Col>
              <Button transparent onPress={() => Actions.qtwoSix()} style={styles.center}>
                  <Icon name='arrow-back' />
              </Button>
            </Col>
            <Col>
              <Button transparent onPress={() => Actions.qtwoEight()} style={styles.center}>
...
export default connect(mapStateToProps, bindAction)(QtwoSeven);
